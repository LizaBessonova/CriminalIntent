...
public class TiketListFragmentClosed extends Fragment {
    ...
    private void updateUI(){
        TiketLabClosed tiketLabClosed = TiketLabClosed.get(getActivity());
        List<Tiket> tikets = tiketLabClosed.getTikets();
        //if (mAdapter == null) {
